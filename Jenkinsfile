pipeline {
        ...
        stage('Checkout') {
            steps {
                script {
                    ...
                    checkout([$class: 'GitSCM', branches: [[name: "*/${pullRequestBranch}"]], userRemoteConfigs: [[url: 'https://github.com/program-training/Class5-OSM-back.git']]])
                }
            }
        }
        stage('lint') {
    ...
    post {
        success {
            script {
                echo 'Linting passed... You may noww merge.'
